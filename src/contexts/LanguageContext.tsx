...
export const translations: Record<Language, Record<string, string>> = {
  ...
  gr: {
    ...
    "roster.badge": "Hustle Portfolio",
    "roster.title1": "Επιλεγμένα έργα.",
    "roster.title2": "Στρατηγική και υλοποίηση.",
    "roster.subtitle1": "Σχεδιασμός. Στρατηγική. Μηχανική.",
    "roster.subtitle2": "Μια επιλογή από επιτυχίες που αποδεικνύουν την προσέγγισή μας στην ψηφιακή κυριαρχία.",
