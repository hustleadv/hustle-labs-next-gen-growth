...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "portfolio.cta.badge": "Scale With The Lab",
    "portfolio.cta.title1": "Ready to",
    "portfolio.cta.title2": "Dominate?",
    "portfolio.cta.subtitle": "Let's build your next success story.",
  ...
  gr: {
    ...
    "intro.badge": "The Lab Identity",
    "intro.title1": "Όχι ένα agency.",
    "intro.title2": "Όχι ένα coworking.",
    "intro.title3": "Όχι για όλους.",
    ...
    "portfolio.cta.badge": "Ανάπτυξη με το Lab",
    "portfolio.cta.title1": "Έτοιμοι για",
    "portfolio.cta.title2": "Κυριαρχία;",
    "portfolio.cta.subtitle": "Ας χτίσουμε το επόμενο success story σου.",
