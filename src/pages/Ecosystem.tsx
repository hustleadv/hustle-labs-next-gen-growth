            ...
            <div className="space-y-12">
              {[
                ...
                },
                {
                  ...
                  a: "Μπορείτε να επικοινωνήσετε μαζί μας μέσω email, να εγγραφείτε στο Meetup.com ή να επισκεφθείτε τη σελίδα Meetups του site μας για να δηλώσετε τη θέση σας στα επόμενα events. Οι συναντήσεις γίνονται μηνιαία στο Hustle Space και είναι ανοιχτές σε όλους."
                },
                {
